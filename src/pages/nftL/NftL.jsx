      ...
      <div className={style.infoSection}>
        <div className={style.infoContainer}>
          <div className="content">
            ...
            <Heading as='h2' size='2xl' letterSpacing={2} my={5} textAlign={'center'} margin={'auto'} marginTop={2}>
  <strong>AradChain Technologies’s Proficiency:</strong>
</Heading>

<Text align={'center'} letterSpacing={1} margin={'auto'} marginTop={2}>
  <strong>Models for NFT Loan Platform Development</strong>

  <Text margin={'auto'} marginTop={2}>
  ...
  <Text margin={'auto'} marginTop={2}>
    <strong>Expert Team:</strong> Collaborate with a team experienced in navigating blockchain solutions.
  </Text>
  ...
  <Heading as='h2' size='2xl' letterSpacing={2} my={5} textAlign={'center'} margin={'auto'} marginTop={2}>Frequently Asked Questions</Heading>
  ...
  <Heading margin={'auto'} marginTop={2}>
