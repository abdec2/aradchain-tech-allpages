...
import { Box, List,Button,ListItem,Text, Heading, UnorderedList, Grid, GridItem, SimpleGrid, CardBody, Card } from "@chakra-ui/react";
      ...
      <div className={style.mainSection}>
        <div className={style.mainSectionContainer}>
          <div className={style.mainSectionContent}>
            <div>
              <Heading>Cryptocurrency Payment Gateway Development</Heading>
            </div>
          </div>
...
<List spacing={3} mt={5} textAlign={'center'}>
  <ListItem>
    Bank Accounts: Offer seamless and cost-efficient international transactions between global banks with SEPA IBAN and SWIFT IBAN accounts, supporting multiple currencies.
  </ListItem>
  <ListItem>
    Debit Cards: Our cryptocurrency banking solution features a fully-loaded virtual debit card, expediting payments for online and in-store merchants worldwide using cryptocurrencies.
  </ListItem>
  <ListItem>
    Credit Cards: With our virtual credit card, enjoy a convenient and secure way to make purchases both online and offline, globally accepted, fortified with robust security measures, and flexible repayment options.
  </ListItem>
  <ListItem>
    User-Controlled Wallet: Empower users with complete control over digital assets through a hassle-free wallet for secure and straightforward crypto transactions, complete with private key security.
  </ListItem>
  <ListItem>
    Remittance: Embark on swift and seamless remittance with our innovative platform, offering online accessibility, diverse payout options, and dedicated customer support for a seamless experience.
  </ListItem>
  <ListItem>
    Payments: Optimize your payment processes with our banking solution, managing invoices, tracking payment statuses, and more in a secure and user-friendly digital environment.
  </ListItem>
  <ListItem>
    Merchant Payment Gateway: Our high-performance digital banking solution facilitates various payment modes, including fiat currency, ensuring convenient and instantaneous transactions worldwide.
  </ListItem>
  <ListItem>
    Cryptocurrency Trading Desk: Our scalable solution presents advanced trading tools, real-time market data, and secure infrastructure to execute trades and seize market opportunities with confidence.
  </ListItem>
  <ListItem>
    P2P Transfers: Our cryptocurrency banking solution simplifies financial interactions, allowing customers to send funds to anyone, anywhere, anytime, with just a few clicks on our user-friendly platform.
  </ListItem>
  <ListItem>
    Crypto Loans: With our banking platform, effortlessly use digital assets as collateral to secure loans with customizable and transparent loan terms, coupled with competitive interest rates.
  </ListItem>
  <ListItem>
    Scan & Pay: Leverage the ease and speed of scan & pay for contactless payments by scanning QR codes using your smartphone, ensuring convenient and hygienic transactions.
  </ListItem>
  <ListItem>
    Bill Pay: Streamline bill payments with the bill pay functionality in our cryptocurrency banking solution, enabling hassle-free electronic crypto payments, complete with real-time payment updates and automated reminders.
  </ListItem>
</List>
...
<List textAlign={'center'} spacing={3} mt={5}>
  <ListItem>
    Gather and Analyze Requirements: Initially, our crypto banking experts grasp your business needs and conduct a thorough analysis of your requirements to offer the optimal solution.
  </ListItem>
  <ListItem>
    Develop a Roadmap: Following a meticulous analysis of your business model, our team outlines the entire process and strategy to align with your needs effectively.
  </ListItem>
  <ListItem>
    Prototype Design: We commence by creating a prototype that showcases a demo of our concepts through immersive UI/UX designs.
  </ListItem>
  <ListItem>
    Prototype Approval: Upon completing the prototype, we seek your approval and feedback to finalize our development strategies.
  </ListItem>
  <ListItem>
    Post-Deployment Services: Even post-deployment, AradChain Technologies provides top-notch maintenance services, freeing you from concerns about updates and modifications.
  </ListItem>
  <ListItem>
    Deployment: After our solution passes quality tests and audits, it is finally deployed as per the committed delivery timeline.
  </ListItem>
  <ListItem>
    Quality Assurance: Quality is our priority, and our testing team ensures product security, keeping it free from bugs.
  </ListItem>
  <ListItem>
    Development: Once you grant approval, we proceed with execution, leveraging advanced technologies and proficient techniques.
  </ListItem>
</List>
