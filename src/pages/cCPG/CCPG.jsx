...
import { Box, Text, Heading,ListItem,List, UnorderedList, Grid, GridItem, SimpleGrid, CardBody, Card ,Button,Stack} from "@chakra-ui/react";
...
<List textAlign={'center'} spacing={3} mt={5}>
  ...
  <ListItem>
  <strong>Prototype Approval: </strong>Upon completing the prototype, we seek your approval and feedback to finalize our development strategies.
  </ListItem>
  <ListItem>
