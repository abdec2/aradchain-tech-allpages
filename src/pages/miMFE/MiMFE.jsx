      ...
      <div className={style.mainSection}>
        <div className={style.mainSectionContainer}>
          ...
          <div className={style.mainSectionContent}>
            <div>
              <img src={map} alt="" />
              <h2>Metaverse Applications in Education</h2>
            </div>
            <div>
              <p>
...
VIEW LIVE DEMO TALK TO OUR EXPERTS
...
1How Can I Develop a Metaverse for Education?
Developing a metaverse education platform involves integrating augmented reality, virtual reality, artificial intelligence, and other technologies. These elements create immersive online educational experiences for learners.

2I'm New to the Metaverse Concept. Can You Provide Education Metaverse Consulting?
3What is the Cost for Developing a Metaverse Platform in Education?
4Can You Deliver Customized Services for Virtual Learning Platform Development?
5What is the Estimated Development Timeline for a Metaverse Education Platform?
